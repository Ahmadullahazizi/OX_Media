...
function AddBranch() {
  ...
  useEffect(() => {
    dispatch(GetAllBranch());
    dispatch(GetSingleBranch(branchId)); //get All niche function from slice
  }, [dispatch]);
  ...
  return (
    <>
      <div className="flex flex-wrap justify-center align-top md:justify-start items-start p-6 space-x-4 space-y-4">
        {/* ADD NEW BRANCH */}
          ...
          branch.Branches.map((branch) => {
            return (
              <>
                <Card
                  key={branch._id}
                  className="flex flex-col w-[250px] h-[300px] bg-white border-sky-100 items-center hover:shadow-gray-300"
                >
                            ...
                            <DialogDescription>
                              <Card className="mx-auto max-w-md my-8 ">
                                <CardHeader>
                                  ...
                                  <CardDescription>
                                    Enter new information to update a Branch
                                  </CardDescription>
                                </CardHeader>
                                <CardContent className={"text-left"}>
                                  <form
                                      ...
                                      <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="grid gap-2">
                                          ...
                                          <Input
                                            ...
                                            required
                                            value={
                                              inputValues.local_currency_abbr ||
                                              ""
                                            }
                                            onChange={handleChange}
                                          />
                                      ...
                                      <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="grid gap-2">
                                          ...
                                          <Input
                                            ...
                                            name="branch_website_link"
                                            value={
                                              inputValues.branch_website_link ||
                                              ""
                                            }
                                            onChange={handleChange}
                                          />

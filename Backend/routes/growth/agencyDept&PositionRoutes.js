...
import {
    ...
    getCEO,
    getCEOById,
    deleteCEO} from '../../controllers/growth/agencyDept&PositionController.js'


    //Ox CEO Routes
// the route below http://localhost:3000/api/v1/oxmanagement/ceo - POST
router.post("/ceo",  addCEO);

// the route below http://localhost:3000/api/v1/oxmanagement/ceo - POST
router.put("/ceo/:ceoID",  updateCEO);

// the route below http://localhost:3000/api/v1/oxmanagement/ceo - POST
router.get("/ceo",  getCEO);

// the route below http://localhost:3000/api/v1/oxmanagement/ceo - POST
router.get("/ceo/:ceoID",  getCEOById);

// the route below http://localhost:3000/api/v1/oxmanagement/ceo - POST
router.delete("/ceo/:ceoID",  deleteCEO);
...
router.post("/office",upload.single("SOP_file"),   addOffice);

// the route below http://localhost:3000/api/v1/oxmanagement/office - POST
router.put("/office/:officeID", upload.single("SOP_file"),  updateOffice);
